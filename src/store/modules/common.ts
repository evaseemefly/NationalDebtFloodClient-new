...
const getters = {
	...
	/**
	 * @description 获取 是否显示台风搜索框
	 * @author evaseemefly
	 * @date 2022/09/27
	 * @param {ICommon} state
	 * @returns {*}  {boolean}
	 */
	[GET_SHOW_TYPHOON_SEARCH_FORM](state: Common): boolean {
		return state.isShowTySearchForm
	},
}
// 使用dispatch调用
const actions = {}
...
const mutations = {
	...
	/**
	 * @description 设置 是否显示台风搜索框
	 * @author evaseemefly
	 * @date 2022/09/27
	 * @param {ICommon} state
	 * @param {boolean} isShow
	 */
	[SET_SHOW_TYPHOON_SEARCH_FORM](state: Common, isShow: boolean): void {
		state.isShowTySearchForm = isShow
	},
}
